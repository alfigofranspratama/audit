                    ...
                    <div class="card radius-15 overflow-hidden">
                        <div class="row g-0">
                            <div class="col-xl-6">
                                <div class="card-body p-5">
                                    <div class="text-center">
                                        <img src="<?= base_url('components/images/favicon/') . $settings['favicon'] ?>" width="80" alt="">
                                        <h3 class="mt-4 font-weight-bold mb-2">Welcome Back</h3>
                                        <?= $this->session->flashdata('pesan'); ?>
                                        <?php
                                        if ($this->session->flashdata('success')) {
                                            echo $this->session->flashdata('success');
                                        ?>
                                            <meta http-equiv="refresh" content="2; url=<?= base_url("admin/dashboard"); ?>"><?php
                                                                                                                        }
                                                                                                                            ?>
                                    </div>
                                    <div class="">
                                            ...
                                            <form class="row g-3" method="POST" action="<?= base_url('auth/') ?>">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group" id="show_hide_password">
                                                        <input type="password" class="form-control border-end-0" required name="password" id="inputChoosePassword" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="remember_me" checked="">
                            ...
                            <div class="col-xl-6 bg-login-color d-flex align-items-center justify-content-center">
                                <img src="<?= base_url('components/ux/') ?>assets/images/login-images/login-frent-img.jpg" class="img-fluid" alt="...">
                            </div>
                        </div>
                        <!--end row-->
                    </div>
